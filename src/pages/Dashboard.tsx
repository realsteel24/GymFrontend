      ...
      <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8 ">
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
          ...
          <Card x-chunk="dashboard-01-chunk-1">
            <Link to={`/gym/${gymId}/transactionHistory/all?type=newAd`}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card x-chunk="dashboard-01-chunk-2">
            <Link to={`/gym/${gymId}/transactionHistory/all?type=defaulter`}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">
                  Defaulters
                </CardTitle>
              ...
              <CardContent>
                {statusCountLoading ? (
                  ...
                  <div>
                    <div className="text-2xl font-bold pt-0">
                      {defaulterCount}
                    </div>
                    <p className="text-xs text-muted-foreground">
                      +20.1% from last month
          ...
          <SearchMembers
            id="all"
            gymId={gymId!}
            data={genderCount.female + genderCount.male + genderCount.other}
          />
        </div>
